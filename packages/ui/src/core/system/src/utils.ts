...
/**
 * Checks if a component is a StriveUI component.
 * @param component - The component to check.
 * @returns `true` if the component is a StriveUI component, `false` otherwise.
 */
export const isStriveUIEl = (component: React.ReactComponentElement<any>) => {
  return !!component.type?.render?.displayName?.includes("StriveUI");
};
