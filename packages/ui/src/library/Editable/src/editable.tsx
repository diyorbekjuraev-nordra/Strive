...
import { useComposedRefs } from "@/lib/shared/compose-refs";
import { cn } from "@/lib/utils";
import { VisuallyHiddenInput } from "@/library/VisuallyHiddenInput";
  ...
  (props, forwardedRef) => {
    ...
    return (
      <InputPrimitive
        ...
        onKeyDown={onKeyDown}
        className={cn(
          "flex rounded-md border border-border bg-transparent py-1 text-base shadow-xs transition-colors file:border-0 file:bg-transparent file:font-medium file:text-foreground file:text-sm placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:border-[var(--interactive)] focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50 md:text-sm pl-2",
