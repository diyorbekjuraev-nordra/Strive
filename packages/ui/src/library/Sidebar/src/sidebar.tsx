...
type SidebarContext = {
  ...
  isMobile: boolean;
  toggleSidebar: () => void;
  // Add hover state for floating effect
  isHovered: boolean;
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:fixed group-data-[variant=floating]:z-50 group-data-[variant=floating]:w-[300]"
        >
          {children}
        </div>
      </div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-[var(--interactive)] absolute inset-y-0 z-20 hidden w-3 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-3 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex ",
