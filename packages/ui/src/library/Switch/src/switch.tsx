...
const switchVariants = cva(
  `
    ...
    disabled:cursor-not-allowed disabled:opacity-50 data-[state=unchecked]:bg-[var(--muted-foreground)]/40
  ...
  `,
  {
    variants: {
      ...
      permanent: {
        true: "bg-muted",
        false: "data-[state=checked]:bg-[var(--interactive)]",
      },
    },
    defaultVariants: {
      shape: "pill",
...
export { Switch, SwitchIndicator, SwitchWrapper, switchThumbVariants, switchIndicatorVariants, switchVariants};
