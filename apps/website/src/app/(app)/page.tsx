...
import { Badge, Button } from "@ebrai/strive";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
            ...
            <div key={component.title} className="space-y-5 mb-2.5">
              ...
              >
                <div className="space-y-3.5">
                  <div className="relative overflow-hidden border border-border bg-muted/60 rounded-xl min-h-[185px]  shadow-lg">
                    <Link
                      href={`/docs/${getSlug(component.title)}`}
                      className="block"
                    >
                      <Image
                        src={`/screens/components/thumbnails/${getSlug(
                          component.title
                        )}-light.png`}
                          ...
                          {component.highlight!.examples.map((example) => (
                            ...
                            >
                              <HoverCardTrigger asChild>
                                <Badge
                                  variant="outline"
                                  className="cursor-pointer backdrop-blur-md shadow-md"
                                >
                                  <Link
                                    href={`/docs/${getSlug(
                                      component.title
                              ...
                              <HoverCardContent
                                side="top"
                                align="start"
                                className="relative dark:bg-[#09090B] p-4 w-auto border-muted rounded-sm overflow-hidden"
                              >
                                ...
                                >
                                  <img
                                    src={`/screens/components/examples/${getSlug(
                                      component.title
                                    )}/${getSlug(example)}-light.png`}
                                    className="w-auto dark:hidden"
                                    alt=""
                                  />
                                  <img
